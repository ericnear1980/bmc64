...
/* USERPORT_JOYSTICK constants removed in VICE 3.9 - keep for menu compat */
...
void emux_add_drive_option(struct menu_item* root, int drive) {
  ...
  switch (drive) {
     case 8:
        ...
        button = drive_has_buttons(0);
        break;
     case 9:
        id = MENU_CMDHD_MODE_9;
        button = drive_has_buttons(1);
        break;
     case 10:
        id = MENU_CMDHD_MODE_10;
        button = drive_has_buttons(2);
        break;
     case 11:
        id = MENU_CMDHD_MODE_11;
        button = drive_has_buttons(3);
        break;
     default:
        id = MENU_CMDHD_MODE_8;
        button = drive_has_buttons(0);
