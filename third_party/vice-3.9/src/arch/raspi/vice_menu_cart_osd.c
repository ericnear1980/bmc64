...
int emux_attach_cart(int menu_id, char* filename) {
  ...
  switch (menu_id) {
     ...
     case MENU_PLUS4_CART_C0_LO_FILE:
       cart_type = CARTRIDGE_PLUS4_GENERIC_C1LO; /* C0 removed in VICE 3.9, map to C1 */
       break;
     case MENU_PLUS4_CART_C0_HI_FILE:
       cart_type = CARTRIDGE_PLUS4_GENERIC_C1HI; /* C0 removed in VICE 3.9, map to C1 */
       break;
     case MENU_PLUS4_CART_C1_LO_FILE:
       cart_type = CARTRIDGE_PLUS4_GENERIC_C1LO;
       break;
     case MENU_PLUS4_CART_C1_HI_FILE:
       cart_type = CARTRIDGE_PLUS4_GENERIC_C1HI;
       break;
     case MENU_PLUS4_CART_C2_LO_FILE:
       cart_type = CARTRIDGE_PLUS4_GENERIC_C2LO;
       break;
     case MENU_PLUS4_CART_C2_HI_FILE:
       cart_type = CARTRIDGE_PLUS4_GENERIC_C2HI;
       break;
     default:
       cart_type = CARTRIDGE_CRT;
       break;
