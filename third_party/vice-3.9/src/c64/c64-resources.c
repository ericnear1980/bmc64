...
/* BMC64: all revisions map to "kernal" to match SD card layout */
static struct kernal_s kernal_match[] = {
    { "kernal", C64_KERNAL_REV1 },
    { "kernal", C64_KERNAL_REV2 },
    { "kernal", C64_KERNAL_REV3 },
    { "kernal", C64_KERNAL_JAP },
    { "kernal", C64_KERNAL_SX64 },
    { "kernal", C64_KERNAL_GS64 },
    { "kernal", C64_KERNAL_4064 },
    { "kernal-none.bin", C64_KERNAL_NONE },
...
static const resource_string_t resources_string[] = {
    { "ChargenName", "chargen", RES_EVENT_NO, NULL,
      /* BMC64: use short names matching SD card layout */
